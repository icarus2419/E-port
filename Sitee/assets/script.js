(() => {
  ...
  /* Featured video button: keep the exact visual style, but do not run the old
     car-launch animation. While the href is "#" it behaves as a preview-only
     button: no navigation, no jump-to-top, no animation on click. If you later
     replace href="#" with a real 3D portfolio URL, the link will work normally. */
  document.querySelectorAll('.hero-video').forEach((btn) => {
    ...
    btn.addEventListener('click', (e) => {
      ...
      const hasRealDestination = href && href !== '#';
